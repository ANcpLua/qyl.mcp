...
test("evaluation engine uses real invocation evidence and preserves suite order", async () => {
    ...
    const invocations: EvaluationInvocationPort = {
        async invoke(request) {
            ...
            return {
                ...
                result: { answer: 42 },
                usage: {
                    tokenUsage: { input_tokens: 4, output_tokens: 2, total_tokens: 6, estimated: false },
                    cost: { amount_usd: 0.0001, estimated: false, source: "fixture" },
                },
                traceId: "a".repeat(32),
                spanId: "b".repeat(16),
            };
