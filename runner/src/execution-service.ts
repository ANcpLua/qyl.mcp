...
export type ExecutionErrorCategory = RunnerMcpErrorCategory;
export type ExecutionEffect = RunnerMcpExecutionEffect;
export type ExecutionError = RunnerMcpError;
export type ExecutionConfirmationRequest = RunnerMcpExecutionConfirmationRequest;
export type ExecutionConfirmationEvidence = RunnerMcpExecutionConfirmationEvidence;
        ...
        try {
            ...
            if (cancellationWon) {
                ...
                record.error = {
                    ...
                    occurredAt: timestamp(completedMs),
                    retryable: false,
                };
            } else {
                record.result = sanitizePersistedToolResult(result, this.redactor);
